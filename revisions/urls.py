...
urlpatterns = [
    ...
    path('materials_type/', MaterialTypeListView.as_view(), name='materials_type_list'),
    path('material_type/<int:pk>/', MaterialTypeDetailView.as_view(), name='material_type_detail'),
    path('material_type/add/', MaterialTypeCreateView.as_view(), name='add_material_type'),
    path('material_type/edit/<int:pk>/', MaterialTypeUpdateView.as_view(), name='edit_material_type'),
    path('material_type/delete/<int:pk>', MaterialTypeDeleteView.as_view(), name='delete_material_type'),

    path('standards_ppe/', StandardPpeListView.as_view(), name='standards_ppe_list'),
    ...
    path('types_of_ppe', TypeOfPpeListView.as_view(), name='types_of_ppe_list'),
    path('type_of_ppe/<int:pk>/', TypeOfPpeDetailView.as_view(), name='type_of_ppe_detail'),
    path('type_of_ppe/add/', TypeOfPpeCreateView.as_view(), name='add_type_of_ppe'),
    path('type_of_ppe/edit/<int:pk>/', TypeOfPpeUpdateView.as_view(), name='edit_type_of_ppe'),
    path('type_of_ppe/delete/<int:pk>', TypeOfPpeDeleteView.as_view(), name='delete_type_of_ppe'),


    path('revision_data/', RevisionDataListView.as_view(), name='revision_datas_list'),
    ...
    path('records/', RevisionRecordListView.as_view(), name='revision_records_list'),
